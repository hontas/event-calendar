...
module.exports={"name":"event-calendar","version":"0.7.0","description":"Simple calendar for listing events","repository":"https://github.com/hontas/event-calendar.git","main":"src/js/calendar.js","keywords":["calendar","events","event"],"scripts":{"clean":"rimraf dist/*","bumb":"npm version minor","bumb:patch":"npm version patch","bumb:major":"npm version major","minor":"npm run bumb && npm publish","patch":"npm run bumb:patch && npm publish","prepublish":"npm run build","postpublish":"npm run deploy && git push --tags","prebuild":"npm run clean -s","build":"npm run build:scripts -s && npm run build:styles -s && npm run build:markup -s","build:scripts":"browserify --debug src/js/calendar.js --standalone eventCalendar --transform babelify --plugin [minifyify --map event-calendar.min.map.json --output dist/event-calendar.min.map.json] > dist/event-calendar.min.js","build:styles":"stylus src/styles/event-calendar.styl --sourcemap --compress --out dist","build:markup":"jade src/views/index.jade --out dist/","lint":"eslint src","test":"npm run test:unit && npm run test:integration","test:unit":"mocha --reporter nyan test/unit","test:integration":"karma start --single-run","watch":"parallelshell 'npm run watch:build -s' 'npm run watch:lint -s' 'npm run watch:test -s'","watch:lint":"nodemon --quiet --watch src/ --ext '.' --exec 'npm run lint'","watch:test":"npm run test:unit -- --watch & nodemon --quiet --watch test/integration/ --watch dist/ --exec 'karma start --single-run'","watch:build":"nodemon --quiet --watch src/ --ext '.' --exec 'npm run build'","deploy":"gh-pages -d dist","serve":"http-server -p 3000 dist/","open":"opener http://localhost:3000","dev":"npm run open -s & parallelshell 'npm run serve -s' 'npm run watch -s'","ci":"npm install && npm run ... xxx"},"author":"Pontus Lundin <lundin.pontus@gmail.com> (https://github.com/hontas)","license":"ISC","dependencies":{"object-assign":"^4.0.1"},"devDependencies":{"babel":"^5.8.23","babel-eslint":"^4.1.1","babelify":"^6.3.0","browserify":"^11.0.1","chai":"^3.2.0","eslint":"^1.3.1","eslint-config-airbnb":"0.0.8","eslint-plugin-react":"^3.3.1","gh-pages":"^0.4.0","http-server":"^0.8.0","jade":"^1.11.0","karma":"^0.13.9","karma-babel-preprocessor":"^5.2.2","karma-chai":"^0.1.0","karma-mocha":"^0.2.0","karma-phantomjs-launcher":"^0.2.1","karma-sinon-chai":"^1.1.0","minifyify":"^7.0.6","mocha":"^2.3.2","nodemon":"^1.7.0","opener":"^1.4.1","parallelshell":"^2.0.0","phantomjs":"^1.9.18","phantomjs-polyfill":"0.0.1","rimraf":"^2.4.3","sinon":"^1.16.1","sinon-chai":"^2.8.0","stylus":"^0.52.4"}}
},{}],3:[function(require,module,exports){
"use strict";function _interopRequireDefault(e){return e&&e.__esModule?e:{"default":e}}function _toConsumableArray(e){if(Array.isArray(e)){for(var t=0,n=Array(e.length);t<e.length;t++)n[t]=e[t];return n}return Array.from(e)}function eventCalendar(e){function t(){r(),n()}function n(){j.classList.add(prefix+"__container"),j.appendChild(W)}function r(){W=_("table",{className:prefix});var e=_("thead");F=_("tbody"),e.innerHTML=f(),W.appendChild(a()),W.appendChild(e),W.appendChild(F)}function a(){var e=_("caption");return i(),q=_("div",{className:prefix+"__caption"}),e.appendChild(J),e.appendChild(G),e.appendChild(q),e}function i(){J=_("button",{textContent:"<",className:prefix+"__prev-btn"}),G=_("button",{textContent:">",className:prefix+"__next-btn"}),J.addEventListener("click",u),G.addEventListener("click",o)}function s(e){if(e){var t=_utils.date(R.currentTime).month(e-1);return l({currentTime:t.valueOf()}),C(evts.DID_CHANGE_MONTH,t.month()+1),z}return _utils.date(R.currentTime).month()+1}function u(){var e=_utils.date(R.currentTime).subtractMonth();l({currentTime:e.valueOf()}),C(evts.DID_CHANGE_MONTH,e.month())}function o(){var e=_utils.date(R.currentTime).addMonth();l({currentTime:e.valueOf()}),C(evts.DID_CHANGE_MONTH,e.month())}function l(e){C(evts.WILL_CHANGE_STATE,e),R=_objectAssign2["default"]({},R,e),d()}function c(e){if(!_utils.isString(e)||0===e.length)throw Error("setLocale: Argument must be valid language string, eg en or sv");V=e,j.getElementsByTagName("thead")[0].innerHTML=f(),d()}function d(){C(evts.WILL_RENDER);var e=_("tbody",{innerHTML:m()});q.textContent=_utils.capitalize(B.getMonth(_utils.date(R.currentTime).month())),W.replaceChild(e,F),F=e,C(evts.DID_RENDER)}function _(e){var t=arguments.length<=1||void 0===arguments[1]?{}:arguments[1],n=document.createElement(e);return Object.keys(t).forEach(function(e){n[e]=t[e]}),n}function f(){var e=_utils.range(7).map(function(e){return _utils.capitalize(B.getWeekDay(e))}).map(T).join("");return y(e)}function v(e){var t=R.events.filter(function(t){return _utils.date(t.date).isSameDay(e.timestamp)}).sort(function(e,t){return new Date(e.date).getTime()-new Date(t.date).getTime()});return b({day:e,events:t})}function p(e,t){return t%7?e:y(e)}function m(){return h().map(v).map(p).join("")}function h(){function e(e){var t=e.month();return t===o||t===r?!0:t===l?e.weekday()!==B.getWeekStart():void 0}for(var t=[],n=_utils.date(R.currentTime),r=n.month(),a=_utils.date(n).date(1).weekday(B.getWeekStart()),i=_utils.date(a),s=function(){return 0===r?[11,1]:11===r?[10,0]:[r-1,r+1]}(),u=_slicedToArray(s,2),o=u[0],l=u[1];e(i);)t.push({dayOfMonth:i.date(),timestamp:i.valueOf(),isOtherMonth:i.month()!==r}),i.addDay();return t}function g(e){if(j){for(var t=j.firstChild;t;)j.removeChild(t),t=j.firstChild;Object.keys(Z).forEach(function(e){Z[e]=null}),j=null,R=null,W=null,q=null,F=null,J=null,G=null,z=null}_utils.isFunction(e)&&e()}function y(e){return"<tr>"+e}function T(e){return'<th class="'+prefix+'__head">\n        '+e.substr(0,1)+'<span class="rest">'+e.substr(1,2)+'<span class="ending">'+e.substr(3)+"</span><span>\n      </th>"}function E(e){if(_utils.isFunction(O))return O(e);var t=_utils.date(e.date).time(B.isTwelveHours())+" "+e.name,n=e.link?"a":"span",r=e.link?'href="'+e.link+'"':"";return"<"+n+' class="'+prefix+'__cell__event" '+r+' title="'+t+'">\n        <span class="event-time">'+_utils.date(e.date).time(B.isTwelveHours())+'</span>\n        <span class="event-name">'+e.name+'</span>\n        <span class="event-dot"></span>\n      </'+n+">"}function b(e){var t=e.day,n=e.events;if(_utils.isFunction(L))return L({day:t,events:n});var r=n.length?prefix+"__cell--active":"",a=t.isOtherMonth?prefix+"__cell--passive":"",i=n.map(E).join("");return"<td class='"+prefix+"__cell "+r+" "+a+"'>\n        "+i+"\n        <span class='"+prefix+"__cell__date'>"+t.dayOfMonth+"</span>\n      </td>"}function D(e,t){return Z[e]||(Z[e]=[]),Z[e]=[].concat(_toConsumableArray(Z[e]),[t]),z}function A(e,t){return Z[e]=Z[e].filter(function(e){return e!==t}),0===Z[e].length&&delete Z[e],z}function C(e,t){Z[e]&&Z[e].forEach(function(e){return e(t)})}function N(){if(!k||!_utils.isString(k))throw Error(errors.INVALID_SELECTOR);if(j=document.querySelector(k),!j)throw Error(errors.SELECTOR_DID_NOT_MATCH);I&&(D(evts.WILL_RENDER,function(){console.time("render")}),D(evts.DID_RENDER,function(){console.timeEnd("render")})),R=_objectAssign2["default"]({},{currentTime:Date.now(),events:[]},H),t(),d(),C(evts.INITIALIZED)}var k=e.selector,I=e.debug,L=e.tdTemplate,O=e.eventTemplate,M=e.locale,w=e.i18n,x=void 0===w?{}:w,S=e.state,H=void 0===S?{}:S,j=void 0,R=void 0,W=void 0,q=void 0,F=void 0,J=void 0,G=void 0,z=void 0,V=M||"en",Z={},B=_objectAssign2["default"]({},lang,x,{getWeekDay:function(e){var t=e+this.getWeekStart();return this[V].weekdays[t>6?0:t]},getMonth:function(e){return this[V].months[e]},getWeekStart:function(){return this[V].startOfWeek},isTwelveHours:function(){return this[V].twelveHourFormat}});return N(),z={render:d,setState:l,setLocale:c,month:s,on:D,off:A,destroy:g,_events:Z}}Object.defineProperty(exports,"__esModule",{value:!0});var _slicedToArray=function(){function e(e,t){var n=[],r=!0,a=!1,i=void 0;try{for(var s,u=e[Symbol.iterator]();!(r=(s=u.next()).done)&&(n.push(s.value),!t||n.length!==t);r=!0);}catch(o){a=!0,i=o}finally{try{!r&&u["return"]&&u["return"]()}finally{if(a)throw i}}return n}return function(t,n){if(Array.isArray(t))return t;if(Symbol.iterator in Object(t))return e(t,n);throw new TypeError("Invalid attempt to destructure non-iterable instance")}}(),_objectAssign=require("object-assign"),_objectAssign2=_interopRequireDefault(_objectAssign),_packageJson=require("../../package.json"),_packageJson2=_interopRequireDefault(_packageJson),_utils=require("./utils"),evts={INITIALIZED:"initialized",WILL_RENDER:"will-render",DID_RENDER:"did-render",WILL_CHANGE_STATE:"will-change-state",DID_CHANGE_MONTH:"did-change-month"},prefix="evt-calendar",errors={SELECTOR_DID_NOT_MATCH:"Selector did not match any element",INVALID_SELECTOR:"Must supply css-selector as string"},lang={en:{months:"January_February_March_April_May_June_July_August_September_October_November_December".split("_"),weekdays:"Sunday_Monday_Tuesday_Wednesday_Thursday_Friday_Saturday".split("_"),startOfWeek:0,twelveHourFormat:!0},sv:{months:"januari_februari_mars_april_maj_juni_juli_augusti_september_oktober_november_december".split("_"),weekdays:"söndag_måndag_tisdag_onsdag_torsdag_fredag_lördag".split("_"),startOfWeek:1}};eventCalendar.version=_packageJson2["default"].version,exports["default"]=eventCalendar,module.exports=exports["default"];
