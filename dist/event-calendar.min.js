(function(f){if(typeof exports==="object"&&typeof module!=="undefined"){module.exports=f()}else if(typeof define==="function"&&define.amd){define([],f)}else{var g;if(typeof window!=="undefined"){g=window}else if(typeof global!=="undefined"){g=global}else if(typeof self!=="undefined"){g=self}else{g=this}g.eventCalender = f()}})(function(){var define,module,exports;return (function e(t,n,r){function s(o,u){if(!n[o]){if(!t[o]){var a=typeof require=="function"&&require;if(!u&&a)return a(o,!0);if(i)return i(o,!0);var f=new Error("Cannot find module '"+o+"'");throw f.code="MODULE_NOT_FOUND",f}var l=n[o]={exports:{}};t[o][0].call(l.exports,function(e){var n=t[o][1][e];return s(n?n:e)},l,l.exports,e,t,n,r)}return n[o].exports}var i=typeof require=="function"&&require;for(var o=0;o<r.length;o++)s(r[o]);return s})({1:[function(require,module,exports){
...
"use strict";function _interopRequireDefault(e){return e&&e.__esModule?e:{"default":e}}function _toConsumableArray(e){if(Array.isArray(e)){for(var t=0,n=Array(e.length);t<e.length;t++)n[t]=e[t];return n}return Array.from(e)}function eventCalendar(e){function t(){r(),n()}function n(){M.classList.add(prefix+"__container"),M.appendChild(w)}function r(){w=s("table",{className:prefix});var e=s("thead");j=s("tbody"),e.innerHTML=d(),w.appendChild(i()),w.appendChild(e),w.appendChild(j)}function i(){var e=s("caption");return a(),S=s("div",{className:prefix+"__caption"}),e.appendChild(k),e.appendChild(q),e.appendChild(S),e}function a(){k=s("button",{textContent:"<",className:prefix+"__prev-btn"}),q=s("button",{textContent:">",className:prefix+"__next-btn"}),k.addEventListener("click",o),q.addEventListener("click",u)}function o(){var e=_moment2["default"](H.currentTime).subtract(1,"month");l({currentTime:e.valueOf()}),A(evts.DID_CHANGE_MONTH,e.month())}function u(){var e=_moment2["default"](H.currentTime).add(1,"month");l({currentTime:e.valueOf()}),A(evts.DID_CHANGE_MONTH,e.month())}function l(e){A(evts.WILL_CHANGE_STATE,e),H=_objectAssign2["default"]({},H,e),c()}function c(){A(evts.WILL_RENDER);var e=s("tbody",{innerHTML:_()});S.textContent=_utils.capitalize(_moment2["default"](H.currentTime).format("MMMM")),w.replaceChild(e,j),j=e,A(evts.DID_RENDER)}function s(e){var t=arguments.length<=1||void 0===arguments[1]?{}:arguments[1],n=document.createElement(e);return Object.keys(t).forEach(function(e){n[e]=t[e]}),n}function d(){var e=_moment2["default"](),t=_utils.range(7).map(function(t){return _utils.capitalize(e.weekday(t).format("dddd"))}).map(h).join("");return p(t)}function f(e){var t=H.events.filter(function(t){return _moment2["default"](t.date).isSame(e.timestamp,"day")}).sort(function(e,t){return new Date(e.date).getTime()-new Date(t.date).getTime()});return y({day:e,events:t})}function m(e,t){return t%7?e:p(e)}function _(){return v().map(f).map(m).join("")}function v(){function e(e){var t=e.month();return t===l||t===r?!0:t===c?!!e.weekday():void 0}for(var t=[],n=_moment2["default"](H.currentTime),r=n.month(),i=_moment2["default"](n).date(1).weekday(0),a=_moment2["default"](i),o=function(){return 0===r?[11,1]:11===r?[10,0]:[r-1,r+1]}(),u=_slicedToArray(o,2),l=u[0],c=u[1];e(a);)t.push({dayOfMonth:a.date(),timestamp:a.valueOf(),isOtherMonth:a.month()!==r}),a.add(1,"day");return t}function p(e){return"<tr>"+e}function h(e){return"<th>"+e+"</th>"}function E(e){if(_utils.isFunction(g))return g(e);var t=_moment2["default"](e.date).format("HH:mm")+" "+e.name;return e.link?'<a class="'+prefix+'__cell__event" href="'+e.link+'">\n          '+t+"\n        </a>":'<span class="'+prefix+'__cell__event">\n        '+t+"\n      </span>"}function y(e){var t=e.day,n=e.events;if(_utils.isFunction(b))return b({day:t,events:n});var r=n.length?prefix+"__cell--active":"",i=t.isOtherMonth?prefix+"__cell--passive":"",a=n.map(E).join("");return"<td class='"+prefix+"__cell "+r+" "+i+"'>\n        "+a+"\n        <span class='"+prefix+"__cell__date'>"+t.dayOfMonth+"</span>\n      </td>"}function T(e,t){return R[e]||(R[e]=[]),R[e]=[].concat(_toConsumableArray(R[e]),[t]),G}function D(e,t){return R[e]=R[e].filter(function(e){return e!==t}),G}function A(e,t){R[e]&&R[e].forEach(function(e){return e(t)})}function C(){if(!I||!_utils.isString(I))throw Error(errors.INVALID_SELECTOR);if(M=document.querySelector(I),!M)throw Error(errors.SELECTOR_DID_NOT_MATCH);L&&_moment2["default"].locale(L),N&&(T(evts.WILL_RENDER,function(){console.time("render")}),T(evts.DID_RENDER,function(){console.timeEnd("render")})),H=_objectAssign2["default"]({},{currentTime:Date.now(),events:[]},O),t(),c(),A(evts.INITIALIZED)}var I=e.selector,L=e.momentLocale,N=e.debug,b=e.tdTemplate,g=e.eventTemplate,x=e.state,O=void 0===x?{}:x,R={},M=void 0,H=void 0,w=void 0,S=void 0,j=void 0,k=void 0,q=void 0,G=void 0;return C(),G={render:c,setState:l,on:T,off:D}}Object.defineProperty(exports,"__esModule",{value:!0});var _slicedToArray=function(){function e(e,t){var n=[],r=!0,i=!1,a=void 0;try{for(var o,u=e[Symbol.iterator]();!(r=(o=u.next()).done)&&(n.push(o.value),!t||n.length!==t);r=!0);}catch(l){i=!0,a=l}finally{try{!r&&u["return"]&&u["return"]()}finally{if(i)throw a}}return n}return function(t,n){if(Array.isArray(t))return t;if(Symbol.iterator in Object(t))return e(t,n);throw new TypeError("Invalid attempt to destructure non-iterable instance")}}(),_moment=require("moment"),_moment2=_interopRequireDefault(_moment),_objectAssign=require("object-assign"),_objectAssign2=_interopRequireDefault(_objectAssign),_utils=require("./utils"),evts={INITIALIZED:"initialized",WILL_RENDER:"will-render",DID_RENDER:"did-render",WILL_CHANGE_STATE:"will-change-state",DID_CHANGE_MONTH:"did-change-month"},prefix="evt-calendar",errors={SELECTOR_DID_NOT_MATCH:"Selector did not match any element",INVALID_SELECTOR:"Must supply css-selector as string"};exports["default"]=eventCalendar,module.exports=exports["default"];
},{"./utils":4,"moment":1,"object-assign":2}],4:[function(require,module,exports){
"use strict";function find(n,t,i){function r(n){return t instanceof RegExp?i?t.test(n[i]):t.test(n):"function"==typeof t?t(i?n[i]:n):i?n[i]===t:n===t}var e=null;return n.some(function(n){var t=r(n);return t?(e=n,!0):void 0}),e}function mapBy(n,t){return Array.isArray(t)?n.map(function(n){return t.reduce(function(t,i){return t[i]=n[i],t},{})}):n.map(function(n){return n[t]})}function capitalize(n){if("string"!=typeof n)throw Error("Argument must be of type String");return n.slice(0,1).toUpperCase()+n.slice(1)}function range(n){var t=0,i=[];do i.push(t);while(++t<n);return i}function is(n,t){return typeof n===t}function isFunction(n){return is(n,"function")}function isString(n){return is(n,"string")}Object.defineProperty(exports,"__esModule",{value:!0}),exports.find=find,exports.mapBy=mapBy,exports.capitalize=capitalize,exports.range=range,exports.isFunction=isFunction,exports.isString=isString,exports["default"]={find:find,mapBy:mapBy,capitalize:capitalize,range:range,isFunction:isFunction,isString:isString};
},{}]},{},[3])(3)
});
