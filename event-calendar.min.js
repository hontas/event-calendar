...
"use strict";function _interopRequireDefault(e){return e&&e.__esModule?e:{"default":e}}function _toConsumableArray(e){if(Array.isArray(e)){for(var t=0,n=Array(e.length);t<e.length;t++)n[t]=e[t];return n}return Array.from(e)}function eventCalender(e){function t(){r(),n()}function n(){R.classList.add(prefix+"__container"),R.appendChild(j)}function r(){j=d("table",{className:prefix});var e=d("thead");S=d("tbody"),e.innerHTML=s(),j.appendChild(i()),j.appendChild(e),j.appendChild(S)}function i(){var e=d("caption");return a(),w=d("div",{className:prefix+"__caption"}),e.appendChild(k),e.appendChild(q),e.appendChild(w),e}function a(){k=d("button",{textContent:"<",className:prefix+"__prev-btn"}),q=d("button",{textContent:">",className:prefix+"__next-btn"}),k.addEventListener("click",o),q.addEventListener("click",u)}function o(){var e=_moment2["default"](H.currentTime).subtract(1,"month");c({currentTime:e.valueOf()}),A(evts.DID_CHANGE_MONTH,e.month())}function u(){var e=_moment2["default"](H.currentTime).add(1,"month");c({currentTime:e.valueOf()}),A(evts.DID_CHANGE_MONTH,e.month())}function c(e){A(evts.WILL_CHANGE_STATE,e),H=_objectAssign2["default"]({},H,e),l()}function l(){A(evts.WILL_RENDER);var e=d("tbody",{innerHTML:_()});w.textContent=_utils.capitalize(_moment2["default"](H.currentTime).format("MMMM")),j.replaceChild(e,S),S=e,A(evts.DID_RENDER)}function d(e){var t=arguments.length<=1||void 0===arguments[1]?{}:arguments[1],n=document.createElement(e);return Object.keys(t).forEach(function(e){n[e]=t[e]}),n}function s(){var e=_moment2["default"](),t=_utils.range(7).map(function(t){return _utils.capitalize(e.weekday(t).format("dddd"))}).map(h).join("");return p(t)}function f(e){var t=H.events.filter(function(t){return _moment2["default"](t.date).isSame(e.timestamp,"day")}).sort(function(e,t){return new Date(e.date).getTime()-new Date(t.date).getTime()});return E({day:e,events:t})}function m(e,t){return t%7?e:p(e)}function _(){return v().map(f).map(m).join("")}function v(){function e(e){var t=e.month();return t===c||t===r?!0:t===l?!!e.weekday():void 0}for(var t=[],n=_moment2["default"](H.currentTime),r=n.month(),i=_moment2["default"](n).date(1).weekday(0),a=_moment2["default"](i),o=function(){return 0===r?[11,1]:11===r?[10,0]:[r-1,r+1]}(),u=_slicedToArray(o,2),c=u[0],l=u[1];e(a);)t.push({dayOfMonth:a.date(),timestamp:a.valueOf(),isOtherMonth:a.month()!==r}),a.add(1,"day");return t}function p(e){return"<tr>"+e}function h(e){return"<th>"+e+"</th>"}function y(e){if(_utils.isFunction(g))return g(e);var t=_moment2["default"](e.date).format("HH:mm")+" "+e.name;return e.link?'<a class="'+prefix+'__cell__event" href="'+e.link+'">\n          '+t+"\n        </a>":'<span class="'+prefix+'__cell__event">\n        '+t+"\n      </span>"}function E(e){var t=e.day,n=e.events;if(_utils.isFunction(x))return x({day:t,events:n});var r=n.length?prefix+"__cell--active":"",i=t.isOtherMonth?prefix+"__cell--passive":"",a=n.map(y).join("");return"<td class='"+prefix+"__cell "+r+" "+i+"'>\n        "+a+"\n        <span class='"+prefix+"__cell__date'>"+t.dayOfMonth+"</span>\n      </td>"}function T(e,t){return O[e]||(O[e]=[]),O[e]=[].concat(_toConsumableArray(O[e]),[t]),G}function D(e,t){return O[e]=O[e].filter(function(e){return e!==t}),G}function A(e,t){O[e]&&O[e].forEach(function(e){return e(t)})}function C(){if(R=document.querySelector(b),!R)throw Error(errors.SELECTOR_DID_NOT_MATCH);I&&_moment2["default"].locale(I),N&&(T(evts.WILL_RENDER,function(){console.time("render")}),T(evts.DID_RENDER,function(){console.timeEnd("render")})),H=_objectAssign2["default"]({},{currentTime:Date.now(),events:[]},M),t(),l(),A(evts.INITIALIZED)}var b=e.selector,I=e.momentLocale,N=e.debug,x=e.tdTemplate,g=e.eventTemplate,L=e.state,M=void 0===L?{}:L,O={},R=void 0,H=void 0,j=void 0,w=void 0,S=void 0,k=void 0,q=void 0,G=void 0;return C(),G={render:l,setState:c,on:T,off:D}}Object.defineProperty(exports,"__esModule",{value:!0});var _slicedToArray=function(){function e(e,t){var n=[],r=!0,i=!1,a=void 0;try{for(var o,u=e[Symbol.iterator]();!(r=(o=u.next()).done)&&(n.push(o.value),!t||n.length!==t);r=!0);}catch(c){i=!0,a=c}finally{try{!r&&u["return"]&&u["return"]()}finally{if(i)throw a}}return n}return function(t,n){if(Array.isArray(t))return t;if(Symbol.iterator in Object(t))return e(t,n);throw new TypeError("Invalid attempt to destructure non-iterable instance")}}(),_moment=require("moment"),_moment2=_interopRequireDefault(_moment),_objectAssign=require("object-assign"),_objectAssign2=_interopRequireDefault(_objectAssign),_utils=require("./utils"),evts={INITIALIZED:"initialized",WILL_RENDER:"will-render",DID_RENDER:"did-render",WILL_CHANGE_STATE:"will-change-state",DID_CHANGE_MONTH:"did-change-month"},prefix="evt-calendar",errors={SELECTOR_DID_NOT_MATCH:"Selector did not match any element"};exports["default"]=eventCalender,module.exports=exports["default"];
},{"./utils":4,"moment":1,"object-assign":2}],4:[function(require,module,exports){
"use strict";function find(n,t,e){function r(n){return t instanceof RegExp?e?t.test(n[e]):t.test(n):"function"==typeof t?t(e?n[e]:n):e?n[e]===t:n===t}var i=null;return n.some(function(n){var t=r(n);return t?(i=n,!0):void 0}),i}function mapBy(n,t){return Array.isArray(t)?n.map(function(n){return t.reduce(function(t,e){return t[e]=n[e],t},{})}):n.map(function(n){return n[t]})}function capitalize(n){if("string"!=typeof n)throw Error("Argument must be of type String");return n.slice(0,1).toUpperCase()+n.slice(1)}function range(n){var t=0,e=[];do e.push(t);while(++t<n);return e}function isFunction(n){return"function"==typeof n}Object.defineProperty(exports,"__esModule",{value:!0}),exports.find=find,exports.mapBy=mapBy,exports.capitalize=capitalize,exports.range=range,exports.isFunction=isFunction,exports["default"]={find:find,mapBy:mapBy,capitalize:capitalize,range:range,isFunction:isFunction};
},{}]},{},[3])(3)
});
